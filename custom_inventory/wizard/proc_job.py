...
class custom_procurement_compute_all(osv.osv_memory):
    _inherit = 'procurement.order.compute.all'
    _description = 'Compute all schedulers'

    def _procure_calculation_all(self, cr, uid, context=None):
        """
    ...
    def procure_calculation(self, cr, uid,ids,context=None):
        ...
        @param context: A standard dictionary
        """
        threaded_calculation = threading.Thread(target=self._procure_calculation_all, args=(cr, uid, context))
